...
parser.add_argument('--Netvlad_centers', type=str, default='./kmeans_centers/centers_32x256.npz',
...
parser.add_argument('--pre_trained_model', type=str, default='../../../../Architectures/ResNet/resnet_v2_101.ckpt',
...
def main(unused_argv):
  ...
  for tstep in range(FLAGS.train_epochs // FLAGS.epochs_per_eval):
    print('----------------------------------------------------------------------------------')
